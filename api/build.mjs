...
async function buildAll() {
  ...
  await esbuild({
    ...
    logLevel: "info",
    external: [
      "*.node", "dockerode", "docker-modem", "sharp", "better-sqlite3",
      "sqlite3", "canvas", "bcrypt", "argon2", "fsevents", "re2",
      "farmhash", "xxhash-addon", "bufferutil", "utf-8-validate", "ssh2",
      "cpu-features", "dtrace-provider", "isolated-vm", "lightningcss",
      "pg-native", "pg", "oracledb", "mongodb-client-encryption",
